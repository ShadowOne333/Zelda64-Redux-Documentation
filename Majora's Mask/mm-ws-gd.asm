...
//Notes: DO NOT PATCH. Need to know what most of these are doing.
//B98E2F --> 54
//BA4F6B --> A7
//BB5787 --> A8 //Granny story width (corrupts image)
//BB5927 --> 6A //Granny story transition
//BB75BE --> 02 EE 3C 0E 02 F1 24 63 B0 00 25 CE CF //Granny story (crash)
//BD81DE --> D4
//BD8247 --> 13
//BD827F --> D3
//BD82AF --> D4
...
//BECA16 --> 00 33
//BF06BF --> 61
//C562CA --> 8D 80 07 03 1B 00 07 03 1D //Granny story resource location (?)